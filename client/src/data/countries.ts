...
// Commonly used origin countries for travel from Latin America
export const commonOriginCountries: Country[] = [
  countries.find(c => c.code === "CO") as Country, // Colombia
  countries.find(c => c.code === "MX") as Country, // Mexico
  countries.find(c => c.code === "AR") as Country, // Argentina
  countries.find(c => c.code === "BR") as Country, // Brazil
  countries.find(c => c.code === "CL") as Country, // Chile
  countries.find(c => c.code === "PE") as Country, // Peru
  countries.find(c => c.code === "EC") as Country, // Ecuador
  countries.find(c => c.code === "PA") as Country, // Panama
  countries.find(c => c.code === "CR") as Country, // Costa Rica
  countries.find(c => c.code === "DO") as Country, // Dominican Republic
];

// Commonly visited destinations for travel from Latin America
export const commonDestinationCountries: Country[] = [
  countries.find(c => c.code === "US") as Country, // United States
  countries.find(c => c.code === "ES") as Country, // Spain
  countries.find(c => c.code === "FR") as Country, // France
  countries.find(c => c.code === "IT") as Country, // Italy
  countries.find(c => c.code === "GB") as Country, // United Kingdom
  countries.find(c => c.code === "DE") as Country, // Germany
  countries.find(c => c.code === "CA") as Country, // Canada
  countries.find(c => c.code === "MX") as Country, // Mexico
  countries.find(c => c.code === "JP") as Country, // Japan
  countries.find(c => c.code === "AU") as Country, // Australia
  countries.find(c => c.code === "TH") as Country, // Thailand
  countries.find(c => c.code === "AR") as Country, // Argentina
  countries.find(c => c.code === "BR") as Country, // Brazil
  countries.find(c => c.code === "CL") as Country, // Chile
  countries.find(c => c.code === "PE") as Country, // Peru
