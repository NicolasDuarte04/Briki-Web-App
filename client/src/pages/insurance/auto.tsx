          ...
          >
            <div className="max-w-2xl">
              ...
              <p className="text-lg opacity-90 mb-6">
                Find the perfect coverage to protect your vehicle. From basic liability to premium comprehensive coverage, we have plans to fit every need and budget.
              </p>
      ...
      <ContentWrapper className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-900">Quick Claim Processing</h3>
            <p className="text-gray-600">
