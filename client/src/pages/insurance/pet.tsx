...
export default function PetInsurancePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="w-full bg-gradient-to-br from-pink-600 to-purple-500 text-white">
          ...
          >
            <div className="max-w-2xl">
              ...
              <p className="text-lg opacity-90 mb-6">
                Comprehensive pet insurance plans to keep your beloved companions healthy and happy. From routine care to emergency treatment, we've got you covered.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button 
                  size="lg" 
                  onClick={() => document.getElementById('plans-section')?.scrollIntoView({ behavior: 'smooth' })}
                  className="font-medium bg-white text-pink-600 hover:bg-white/90"
                >
                  Compare Plans
      ...
      <ContentWrapper className="py-16">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 mb-4">Why Choose Our Pet Insurance?</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Complete protection for your pets with affordable plans and excellent care.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-pink-50 to-white p-8 rounded-2xl border border-pink-100 shadow-sm hover:shadow-md transition-all"
          >
            <div className="rounded-full bg-pink-100 w-14 h-14 flex items-center justify-center mb-5">
              <Shield className="h-7 w-7 text-pink-600" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Comprehensive Coverage</h3>
            <p className="text-gray-600">
              Protection for accidents, illnesses, surgeries, and emergency treatments for all life stages.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-full bg-pink-100 w-14 h-14 flex items-center justify-center mb-5">
              <Syringe className="h-7 w-7 text-pink-600" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Preventive Care</h3>
            <p className="text-gray-600">
              Regular check-ups, vaccinations, and wellness exams to keep your pet healthy and happy.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-gray-900">No Surprise Bills</h3>
            <p className="text-gray-600">
              Transparent pricing with no hidden fees and easy claim processing for peace of mind.
            </p>
          </motion.div>
          ...
          >
            <div className="rounded-full bg-pink-100 w-14 h-14 flex items-center justify-center mb-5">
              <BadgeCheck className="h-7 w-7 text-pink-600" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Trusted Vets</h3>
            <p className="text-gray-600">
              Access to a network of qualified veterinarians and specialized pet care professionals.
            </p>
          </motion.div>
        </div>
      </ContentWrapper>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl">
              Choose from our carefully designed pet insurance plans to ensure your furry friend gets the best care possible.
            </p>
          </motion.div>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                <div className="flex-1 relative">
                  ...
                  <Input
                    placeholder="Search pet insurance plans..."
                    value={searchQuery}
                ...
                {paginatedPlans.map((plan, index) => (
                  ...
                  >
                    <PlanCard
                      ...
                      className="h-full border-gray-200 hover:border-pink-300 hover:shadow-lg transition-all duration-300"
                    />
                  </motion.div>
                ))}
              </motion.div>
