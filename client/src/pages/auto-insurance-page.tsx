            ...
            <div className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Auto insurance</span>
                  <span className="block text-primary">simplified</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Compare auto insurance plans from top providers in Colombia and Mexico. Find the perfect coverage for your vehicle with just a few clicks.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
              Choose the right coverage to protect your vehicle and your finances
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="overflow-hidden shadow-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Basic Liability</h3>
                  <CardContent className="p-0 mt-2">
                    <p className="text-base text-gray-500">
                      Covers damages to other vehicles or property if you're found at fault in an accident. This is the minimum required coverage in most places.
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="overflow-hidden shadow-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Collision Coverage</h3>
                  <CardContent className="p-0 mt-2">
                    <p className="text-base text-gray-500">
                      Covers damage to your vehicle in case of a collision with another vehicle or object, regardless of who's at fault.
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="overflow-hidden shadow-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <CardContent className="p-0 mt-2">
                    <p className="text-base text-gray-500">
                      Covers damage to your vehicle from events other than collisions, such as theft, vandalism, natural disasters, and falling objects.
                    </p>
                  </CardContent>
                </div>
              </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">
              Get auto insurance in three simple steps
            </p>
          </div>
          ...
          <div className="mt-12">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="bg-white shadow rounded-lg px-6 py-8 relative">
                ...
                <h3 className="text-xl font-medium text-gray-900 mt-2">Enter Vehicle Details</h3>
                <p className="mt-2 text-base text-gray-500">
                  Provide information about your vehicle, including make, model, year, and current mileage.
                </p>
              </div>
              ...
              <div className="bg-white shadow rounded-lg px-6 py-8 relative">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Review and compare auto insurance quotes from top providers based on your coverage preferences.
                </p>
              </div>
              ...
              <div className="bg-white shadow rounded-lg px-6 py-8 relative">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Select the best plan for your needs and complete your purchase with secure online payment.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-primary">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to protect your vehicle?</span>
