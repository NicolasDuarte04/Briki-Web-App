...
export default function AboutSection() {
  return (
    <section id="about" className="py-40 bg-gradient-to-b from-gray-50 to-gray-100 relative overflow-hidden scroll-mt-20">
      {/* Subtle background decoration */}
      <div className="absolute inset-0">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1400px] h-[700px] bg-gradient-radial from-blue-600/5 via-cyan-500/3 to-transparent rounded-full blur-3xl" />
      </div>
        ...
        >
          ...
          <Card className="p-12 md:p-16 bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-xl rounded-3xl">
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-16 text-center">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Briki Insurance Platform</span>
            </h2>
            ...
            <div className="mt-20 pt-16 border-t border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                ...
                >
                  <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">50K+</div>
                ...
                >
                  <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">20+</div>
                ...
                >
                  <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">98%</div>
