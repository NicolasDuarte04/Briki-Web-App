        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-base font-medium">50,000+ Users</span>
            </div>
            <div className="flex items-center gap-3">
              <Star className="h-6 w-6 text-yellow-500" />
              <span className="text-base font-medium">4.8/5 Rating</span>
            </div>
            <div className="flex items-center gap-3">
              <Zap className="h-6 w-6 text-purple-500" />
              <span className="text-base font-medium">Instant Quotes</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
