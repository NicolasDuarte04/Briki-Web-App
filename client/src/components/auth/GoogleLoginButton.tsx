...
export default function GoogleLoginButton({ mode, className }: GoogleLoginButtonProps) {
  ...
  const handleGoogleLogin = () => {
    try {
      setIsLoading(true);
      trackEvent(`${mode}_with_google_attempt`, "authentication", `google_${mode}`);
      
      // Google authentication is handled via redirect to the backend OAuth route
