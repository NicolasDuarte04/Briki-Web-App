...
export default function UnifiedAuthForm({ mode = "login", onSuccess }: UnifiedAuthFormProps) {
  // State management
        ...
        <form onSubmit={loginForm.handleSubmit(handleLoginSubmit)} className="space-y-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              autoComplete="email"
              className="rounded-lg border-gray-200 bg-white text-gray-800 shadow-sm focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 h-11"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="rounded-lg border-gray-200 bg-white text-gray-800 shadow-sm focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 h-11 pr-10"
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-600/20"
            />
            <label
              htmlFor="rememberMe"
          ...
          <Button 
            type="submit" 
            className="w-full h-11 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 hover:shadow-lg hover:shadow-blue-600/25 text-white font-medium transition-all duration-300"
            disabled={isLoading}
          >
            {isLoading ? (
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 flex items-center justify-center gap-2 border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-blue-600/20 transition-all shadow-sm hover:shadow-md"
      ...
      <form onSubmit={registerForm.handleSubmit(handleRegisterSubmit)} className="space-y-5">
        ...
        <div className="flex items-start space-x-2">
          <Checkbox
            ...
            className="mt-1 h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-600/20"
          />
          <div className="flex flex-col space-y-1">
            <div className="flex flex-wrap items-center">
              ...
              <a 
                href="/terms" 
                className="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline ml-1"
                target="_blank"
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-11 flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 hover:border-blue-600/20 dark:hover:bg-gray-800 transition-all shadow-sm hover:shadow-md"
          onClick={handleGoogleLogin}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" />
